...
| **All-Star BoH**          | `tabs/all-star-boh.html`, `js/all-star-boh-*.js`, `css/all-star-boh.css`, `functions/`, `workers/qwen-cors-proxy.js`                                                                                                             | VTS-only signup with reviewed OCR, configurable 2–6 balanced 12-player teams, admin review filters, safe visible CSV export and batch confirmation, personal Legion plans, and independent Epic preferences                                  | Firebase Auth/App Check/Firestore/Functions and the secured Qwen OCR Worker                                                 | PIN gate and feature modules load only when the internal tab opens                                         |
