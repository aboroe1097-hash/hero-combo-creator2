# Hero Combo Creator - VTS 1097 (v13.0.2)
...
That runs lint, Prettier check, unit tests, i18n validation, production build, bundle-size check, and Playwright smoke tests. The 13.0.2 release should pass the full local gate before shipping.
