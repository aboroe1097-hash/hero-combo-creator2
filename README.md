# Hero Combo Creator — VTS 1097 (v11.3.1)
...
That runs lint, Prettier check, unit tests, i18n validation, production build, bundle-size check, and Playwright smoke tests. The 11.3.1 release should pass the full local gate before shipping.
