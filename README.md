# Hero Combo Creator - VTS 1097 (v14.1.4)
...
| **Specialization Towers** | `js/app-specialization.js`, `js/specialization-towers-v2-*.js`, `js/i18n/specialization-towers-v2/`, `css/app.css`                                                                                                                | Integrated progression planner for Cavalry, Archers, and Footmen towers, with node graphs, milestones, Legion Skills, medal tracking, and community value entry                                                               | Canonical specialization research data and local browser storage                         | Dynamically imported only when the `#specialization` tab opens       |
