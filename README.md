# Hero Combo Creator - VTS 1097 (v14.0.20)
...
| **Specialization Towers** | `specialization-towers.html`, `js/specialization-towers-v2.js`, `js/specialization-towers-v2-*.js`, `js/i18n/specialization-towers-v2/`, `css/specialization-towers-v2.css`                                                      | Standalone progression planner for Cavalry, Archers, and Footmen towers, with learning milestones, Legion Skills, prerequisites, medal costs, and save/export support                                                          | Canonical specialization research data and local browser storage                         | Standalone route; tower app and research data load only when opened  |
