...
export function registerWaveOneAccountSyncAdapters() {
  ...
  registerAccountSyncAdapter({ featureId: 'research-planner', label: 'Research planner plans', storageKey: 'vts_research_planner_v1', serialize: () => object(read('vts_research_planner_v1', null)), parse: object, apply: (value) => write('vts_research_planner_v1', value) });
  registerAccountSyncAdapter({ featureId: 'preset-engine', label: 'Saved presets', storageKey: 'vts_preset_engine_v1', serialize: () => object(read('vts_preset_engine_v1', null)), parse: object, apply: (value) => write('vts_preset_engine_v1', value) });
