...
export const APP_VERSION = '16.0.4';
...
async function loadAdminTemplate() {
  ...
  let res;
  try {
    res = await fetch('tabs/admin.html?v=20260906_222757', { signal: controller.signal });
  } catch (error) {
...
async function bootAdminPage() {
  ...
  bindAdminLanguageSelector();
  await requestAdminLanguage(getLanguage());
  const mod = await import('./ocr-dashboard.js?v=20260906_222757');
