...
const allHeroesData = [
  // ... keep your full hero data array here (same as before) ...
  { name: "Jeanne d'Arc", season: "S0", imageUrl: "https://static.wixstatic.com/media/43ee96_d5f5b07c90924e6ab5b1d70e2667b693~mv2.png" },
  // (truncated in this paste for brevity) — keep the complete list in your actual file
];
...
(async function main() {
  ...
  try {
    ...
    try {
      const { enableIndexedDbPersistence } = await import("https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js");
    ...
    // initialise comments listener/UI (after auth & db ready)
    try {
      await initComments();
    } catch (err) {
