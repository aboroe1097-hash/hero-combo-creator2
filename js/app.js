...
import { initWhatsNewBanner } from './app-whats-new.js?v=20260710_114431';
...
function loadResearchModule() {
  if (!researchModulePromise) {
    researchModulePromise = import('./app-research.js?v=20260710_114431').catch((err) => {
...
function loadMaterialModule() {
  if (!materialModulePromise) {
    materialModulePromise = import('./material-calculator.js?v=20260710_114431').catch((err) => {
  ...
  function onTabActivated(tabName) {
    if (tabName === 'edenMap' && !_edenMapReady && !_edenMapBooting) {
      ...
      loadTabTemplate('edenMap').then(() => {
        ...
        import('./eden-map.js?v=20260710_114431')
    ...
    if (tabName === 'strife' && !_strifeReady) {
      ...
      _strifeBooting = true;
      import('./app-strife.js?v=20260710_114431')
        .then((mod) => {
          mod.initStrifeTool();
          _strifeReady = true;
        })
