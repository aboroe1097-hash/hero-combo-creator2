...
export const rankedCombos = [
  ...
  { heroes: ['Rozen', 'Ramses II', 'Beowulf'], skin: '323', note: 'Immortal Guardian skin is required. Ramses II is recommended; Beowulf is optional.' },
  ...
  { heroes: ['Black Prince', 'Jeane', 'The Avalanche'], skin: '222' },
  ...
  { heroes: ['Beast Queen', 'Rozen Blade', 'Immortal'], skin: '333' },
