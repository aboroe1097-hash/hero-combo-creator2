...
export const rankedCombos = [
  ...
  // Rows here are duplicated above base rank only when the skin table beats no-skin or has no no-skin peer.
  { heroes: ["Cyrus", "Cleopatra VII", "Caesar"], skin: '122', season: 'X1', rocSkinRank: 34, rocNoSkinRank: 35 },
  ...
  { heroes: ["King Arthur", "Bleeding Steed", "Desert Storm"], skin: '331', season: 'X1', rocSkinRank: 133, rocNoSkinRank: 153 },
  { heroes: ["Immortal Guardian", "Sakura", "Jade Eagle"], skin: '313', season: 'X8', rocSkinRank: 136 },
  { heroes: ["Hunk", "Cleopatra VII", "Cao Cao"], skin: '131', season: 'X2', rocSkinRank: 136, rocNoSkinRank: 160 },
  { heroes: ["Hunk", "Bleeding Steed", "Cao Cao"], skin: '131', season: 'X2', rocSkinRank: 137, rocNoSkinRank: 161 },
  { heroes: ["King Arthur", "Cicero", "Bleeding Steed"], skin: '313', season: 'X1', rocSkinRank: 138, rocNoSkinRank: 159 },
  { heroes: ["King Arthur", "Cleopatra VII", "Jade Eagle"], skin: '333', season: 'X1', rocSkinRank: 140 },
  { heroes: ["King Arthur", "Bleeding Steed", "Jade Eagle"], skin: '333', season: 'X1', rocSkinRank: 141 },
  { heroes: ["King Arthur", "Fortuneteller", "Cicero"], skin: '311', season: 'X8', rocSkinRank: 147, rocNoSkinRank: 162 },
  { heroes: ["War Lord", "Jeanne d'Arc", "Mary Tudor"], skin: '132', season: 'S4', rocSkinRank: 151, rocNoSkinRank: 161 },
  { heroes: ["Hunk", "Al Fatih", "Ramses II"], skin: '133', season: 'X2', rocSkinRank: 156 },
  { heroes: ["Edward the Confessor", "Tarantula", "Sakura"], skin: '311', season: 'X2', rocSkinRank: 160 },
  { heroes: ["Theodora", "Che Liu", "Cicero"], skin: '311', season: 'X1', rocSkinRank: 160, rocNoSkinRank: 171 },
  { heroes: ["Soaring Hawk", "Bleeding Steed", "Desert Storm"], skin: '131', season: 'X1', rocSkinRank: 164, rocNoSkinRank: 175 },
  { heroes: ["Peace Bringer", "Jade", "Cao Cao"], skin: '131', season: 'S3', rocSkinRank: 166, rocNoSkinRank: 178 },
  { heroes: ["Rozen Blade", "Al Fatih", "Ramses II"], skin: '333', season: 'S4', rocSkinRank: 166 },
  { heroes: ["Che Liu", "Jade", "Cicero"], skin: '131', season: 'X1', rocSkinRank: 167, rocNoSkinRank: 179 },
  { heroes: ["Genghis Khan", "Jade", "Cao Cao"], skin: '131', season: 'S3', rocSkinRank: 168, rocNoSkinRank: 180 },
  { heroes: ["Peace Bringer", "Bleeding Steed", "Valkyrie"], skin: '131', season: 'X8', rocSkinRank: 171, rocNoSkinRank: 183 },

  { heroes: ["Alexander", "Cleopatra VII", "Theodora"] },
  { heroes: ["King Arthur","Theodora", "Alexander"] },
  { heroes: ["King Arthur","Cleopatra VII","Alexander"] },

  // --- ROC NO-SKIN RANK CANDIDATES ---
  { heroes: ["Alexander", "Ragnar", "Theodora"], season: 'X8', rocNoSkinRank: 18 },
  { heroes: ["Cyrus", "Ragnar", "Caesar"], season: 'X1', rocNoSkinRank: 28 },
  { heroes: ["Cyrus", "Cleopatra VII", "Caesar"], season: 'X1', rocNoSkinRank: 35 },
  { heroes: ["Theodora", "Cyrus", "Caesar"], season: 'X1', rocNoSkinRank: 38 },
  { heroes: ["Alexander", "Theodora", "Bjorn"], season: 'X8', rocNoSkinRank: 41 },
  { heroes: ["Theodora", "Cyrus", "Bjorn"], season: 'X8', rocNoSkinRank: 46 },
  { heroes: ["Cyrus", "Lancelot", "Warhammer"], season: 'X8', rocNoSkinRank: 50 },
  { heroes: ["Warden", "Ramses II", "Beowulf"], season: 'X8' },
  { heroes: ["Cyrus", "Lancelot", "Caesar"], season: 'X8' },
  { heroes: ["Octavius", "Ragnar", "Caesar"], season: 'X1', rocNoSkinRank: 61 },
  { heroes: ["Warhammer", "Lancelot", "The Avalanche"], season: 'X8', rocNoSkinRank: 65 },
  { heroes: ["Bjorn", "Lancelot", "Warhammer"], season: 'X8', rocNoSkinRank: 80 },
  { heroes: ["King Arthur", "Bleeding Steed", "Warhammer"], season: 'X8', rocNoSkinRank: 83 },
  { heroes: ["Cleopatra VII", "Warhammer", "The Avalanche"], season: 'X8', rocNoSkinRank: 85 },
  { heroes: ["King Arthur", "Theodora", "Warhammer"], season: 'X8', rocNoSkinRank: 85 },
  { heroes: ["Ragnar", "Ramses II", "Jade Eagle"], season: 'X1', rocNoSkinRank: 87 },
  { heroes: ["Jeanne d'Arc", "Warhammer", "The Avalanche"], season: 'X8', rocNoSkinRank: 87 },
  { heroes: ["Alexander", "Bleeding Steed", "Warhammer"], season: 'X8', rocNoSkinRank: 88 },
  { heroes: ["Boudica", "Ragnar", "Jade Eagle"], season: 'X1', rocNoSkinRank: 89 },
  { heroes: ["Hunk", "Warden", "Caesar"], season: 'X8', rocNoSkinRank: 89 },
  { heroes: ["Sakura", "Ragnar", "Jade Eagle"], season: 'X1', rocNoSkinRank: 90 },
