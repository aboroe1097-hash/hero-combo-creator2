...
export const STRUCTURE_TYPES = {
  CP1:  { label: 'Gate Lv1',           short: 'G1', category: 'gate',       points: 5,   color: '#94a3b8', size: 4  },
  CP2:  { label: 'Gate Lv2',           short: 'G2', category: 'gate',       points: 5,   color: '#a8b4c4', size: 4  },
  CP3:  { label: 'Gate Lv3',           short: 'G3', category: 'gate',       points: 5,   color: '#7dd3fc', size: 4  },
  CP4:  { label: 'Gate Lv4',           short: 'G4', category: 'gate',       points: 5,   color: '#38bdf8', size: 4  },
  CP5:  { label: 'Gate Lv5',           short: 'G5', category: 'gate',       points: 5,   color: '#0ea5e9', size: 4  },
  CP7:  { label: 'Gate Lv7',           short: 'G7', category: 'gate',       points: 5,   color: '#0284c7', size: 4  },
  ST1:  { label: 'Small Town Lv1',     short: 'ST1', category: 'town',      points: 15,  color: '#4ade80', size: 6  },
  ST3:  { label: 'Small Town Lv3',     short: 'ST3', category: 'town',      points: 20,  color: '#16a34a', size: 6  },
  ST2:  { label: 'Small Town Lv2',     short: 'ST2', category: 'town',      points: 20,  color: '#22c55e', size: 6  },
  LT3:  { label: 'Large Town Lv3',     short: 'LT3', category: 'town',      points: 30,  color: '#3b82f6', size: 8  },
  LT2:  { label: 'Large Town Lv2',     short: 'LT2', category: 'town',      points: 30,  color: '#2563eb', size: 8  },
  LT4:  { label: 'Large Town Lv4',     short: 'LT4', category: 'town',      points: 50,  color: '#6366f1', size: 8  },
  STRHD:{ label: 'Stronghold',         short: 'SH', category: 'stronghold', points: 10,  color: '#f59e0b', size: 9  },
  C5:   { label: 'Capital Lv5',        short: 'C5', category: 'capital',   points: 70,  color: '#f59e0b', size: 10 },
  C6:   { label: 'Capital Lv6',        short: 'C6', category: 'capital',   points: 100, color: '#ef4444', size: 11 },
