export const ALL_STAR_BOH_SHARED_ADDITIONS = Object.freeze({
  ...
  'schedule.kicker': 'EVENT BRIEFING',
  'schedule.matchTimePending': 'Official event date - match time TBA',
  'schedule.milestoneAria': '{stage}: {label}. {status}. {time}.',
  'schedule.now': 'Now',
  'schedule.progressSummary': '{percent}% complete · Stage {current} of {total}',
  'schedule.progressTitle': 'Event progress',
  'schedule.railAria': 'Event milestones',
  'schedule.stagePosition': 'Stage {current} of {total}',
  'schedule.teamTimesAria': 'Team game times',
  'schedule.title': 'Event briefing',
