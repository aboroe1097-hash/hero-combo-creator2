...
const EN = Object.freeze({
  ...
  copy: {
    ...
    pathingIntro:
      'Plan march routes from A to B through gates and mountain passes, then export a PNG for your team.',
    pathingPlan: 'Plan',
    pathingPlanName: 'Plan name',
    pathingDefaultPlan: 'Eden plan {n}',
    pathingNewPlan: 'New plan',
    pathingDeletePlan: 'Delete plan',
    pathingDeletePlanConfirm: 'Delete this plan and all of its routes?',
    pathingRoutes: 'Routes',
    pathingAddRoute: 'Add route',
    pathingDefaultRoute: 'Team {n}',
    pathingRouteName: 'Route name',
    pathingRouteColor: 'Route colour',
    pathingDeleteRoute: 'Delete route',
    pathingStops: 'Stops',
    pathingTapSets: 'Tapping the map sets',
    pathingModeStart: 'Start (A)',
    pathingModeWaypoint: 'Waypoint',
    pathingModeEnd: 'Destination (B)',
    pathingHintStart: 'Tap a structure or open ground to set the start (A).',
    pathingHintEnd: 'Tap where the march ends (B).',
    pathingHintWaypoint: 'Tap a gate to route through it, or open ground to add a mountain pass.',
    pathingSearch: 'Find a structure or coordinates',
    pathingSearchPh: 'Gate, town, capital or 800:800',
    pathingNoResults: 'No matching structures.',
    pathingUseCoords: 'Use point {coords}',
    pathingNoStops: 'No stops yet. Tap the map or search to set the start (A).',
    pathingPassName: 'Mountain pass {n}',
    pathingPointName: 'Point {coords}',
    pathingMoveUp: 'Move up',
    pathingMoveDown: 'Move down',
    pathingRemoveStop: 'Remove stop',
    pathingSuggestGate: 'Add best gate',
    pathingSuggestedGate: '{gate} added as a waypoint.',
    pathingNoGate: 'Set A and B first, then a gate can be suggested.',
    pathingClearStops: 'Clear stops',
    pathingLegTiles: 'Tiles ≈ {tiles}',
    pathingLegTilesWalked: 'Tiles ≈ {tiles} ({walked} walked)',
    pathingTotalTiles: 'Total tiles ≈ {tiles}',
    pathingPathers: 'Pathers: {count} ({each} tiles each)',
    pathingRepeatTiles: 'Tiles walked twice: {tiles}',
    pathingBlocked:
      'A leg is blocked by impassable terrain, so a straight line is shown. Add a mountain pass to steer around it.',
    pathingRouting: 'Routing…',
    pathingNeedTwo: 'Add a destination (B) to draw the route.',
    pathingStopAdded: '{stop} added.',
    pathingShare: 'Share link',
    pathingShareCopied: 'Share link copied.',
    pathingShareManual: 'Copy this link to share the plan:',
    pathingSharedLoaded: 'Shared plan “{plan}” loaded.',
    pathingSharedInvalid: 'That shared plan link is damaged and was ignored.',
    pathingExport: 'Export PNG',
    pathingExportDone: 'PNG exported.',
    pathingExportFailed: 'PNG export failed. Try again.',
    pathingZoomIn: 'Zoom in',
    pathingZoomOut: 'Zoom out',
    pathingFit: 'Fit map',
    pathingMapLabel:
      'Eden pathing map. Drag or use the arrow keys to pan, pinch, scroll or press + and − to zoom, tap to place a stop.',
    pathingGate: 'Gate',
