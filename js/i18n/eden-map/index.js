...
const EN = Object.freeze({
  ...
  copy: {
    ...
    pathingIntro: 'Plan march routes from A to B through gates and mountain passes, then export a PNG for your team.',
    pathingPlan: 'Plan',
    ...
    pathingPathers: 'Estimated pathers: ≈ {count} (assuming {each} tiles each)',
    ...
    pathingFit: 'Fit map',
    pathingMapLabel: 'Eden pathing map. Drag or use the arrow keys to pan, pinch, scroll or press + and − to zoom, tap to place a stop.',
    pathingGate: 'Gate',
