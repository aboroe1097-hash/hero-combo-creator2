...
const hr = Object.freeze({
  ...
  edenX1RewardAnnouncementTitleCount: 'Završnih Top {count}',
  ...
  edenX1RewardAnnouncementCongratsCount: 'Čestitamo, Top {count}!',
  ...
  tabEdenSiege: 'Velov bedem',
  arcadeSiegeKicker: 'Novo · glavna igra',
  arcadeSiegeTitle: 'Velov bedem',
  arcadeSiegeDesc:
    'Arena iz igre Ice & Fire u stvarnom vremenu. Brani utvrdu kao Velo, gradi tornjeve, izbjegavaj udarce vojskovođa i pokušaj osvojiti tri zvjezdice.',
  arcadeSiegePlay: 'Igraj',
  arcadeSiegeDaily: 'Dnevni rat',
  arcadeSiegeDailyNote: 'Današnji Dnevni rat: {map} · {date} — svi igraju istu rundu.',
  arcadeSiegeMapKeep: 'Utvrda',
  arcadeSiegeMapShip: 'Transportni brod',
  siegeCalloutTitle: 'Glasaj za najbolje članove',
  siegeCalloutBody: 'Glasanje članova tima i uprave Edena X2 je otvoreno.',
  siegeCalloutPlay: 'Idi na Eden',
  siegeCalloutDismiss: 'Zatvori',
  hubPdfsTab: 'PDF-ovi',
  hubBuildingsTab: 'Zgrade',
  hubClassRoadmapTab: 'Planovi razvoja',
  ...
  generatorSmartTop4: 'Sastavlja pet kombinacija bez ponavljanja heroja i povećava zbroj bodova četiri najbolje.',
  generatorSmartBtn: 'Pametno generiranje',
