...
// --- APP CONFIG ---
export const APP_VERSION = '16.6.2';
...
export const DEFAULT_HERO_FILTER_SEASONS = ['S0', 'S1', 'X8'];
// The generator opens with every season a player can field, X8 included: the
// combo database now carries the planned X8 catch-up lanes and players look for
// them by default. The season strip still toggles any season off.
export const DEFAULT_GENERATOR_FILTER_SEASONS = ['S0', 'S1', 'S2', 'S3', 'S4', 'X1', 'X2', 'X8'];
