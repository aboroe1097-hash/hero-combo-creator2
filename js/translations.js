import en from './i18n/en.js?v=20260708_101500';

export const translations = { en };
export const translationCoverage = {};

const loaders = {
  ar: () => import('./i18n/ar.js?v=20260708_101500'),
  de: () => import('./i18n/de.js?v=20260708_101500'),
  es: () => import('./i18n/es.js?v=20260708_101500'),
  fr: () => import('./i18n/fr.js?v=20260708_101500'),
  id: () => import('./i18n/id.js?v=20260708_101500'),
  kr: () => import('./i18n/kr.js?v=20260708_101500'),
  pt: () => import('./i18n/pt.js?v=20260708_101500'),
  ru: () => import('./i18n/ru.js?v=20260708_101500'),
  tr: () => import('./i18n/tr.js?v=20260708_101500'),
  zh: () => import('./i18n/zh.js?v=20260708_101500'),
};
