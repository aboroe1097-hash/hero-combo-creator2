...
const LIMITS = {
  ...
  routeCssBytes: {
    ...
    'admin.html': { desktop: 683 * 1024, mobile: 786 * 1024 },
    ...
    // 16.0.14 mobile pass: the admin suggestion controls and the dashboard-wide
    // [hidden] guard live in ocr-dashboard.css, which Eden imports for
