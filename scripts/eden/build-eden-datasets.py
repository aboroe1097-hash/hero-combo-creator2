#!/usr/bin/env python3
"""Build encoded js/eden-datasets.payload.json from database/*.txt per eden-datasets.manifest.json"""
...
OUT_PAYLOAD = ROOT / "js" / "eden-datasets.payload.json"
LEGACY_PAYLOAD_JS = ROOT / "js" / "eden-datasets.payload.js"
