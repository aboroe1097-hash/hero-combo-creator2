...
test('aggregate CSS budget records the current route-isolated feature baseline', () => {
  ...
  assert.match(sizeCheck, /totalJsBytes: 9495 \* 1024/);
  assert.match(sizeCheck, /entryCssBytes: 412 \* 1024/);
  assert.match(sizeCheck, /totalCssBytes: 1558 \* 1024/);
  assert.match(sizeCheck, /totalDeployBytes: 30140 \* 1024/);
  assert.match(sizeCheck, /deployFileCount: 633/);
  assert.match(sizeCheck, /'profile\.html': \{ desktop: 25 \* 1024, mobile: 25 \* 1024 \}/);
  assert.match(sizeCheck, /'arcade\.html': \{ desktop: 444 \* 1024, mobile: 537 \* 1024 \}/);
  assert.match(
    sizeCheck,
